...
public class EquationRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Distance between points: " + equation.distancePoint());
        System.out.println("Your equation: y = " + equation.getSlope() + "x " + "+ " + equation.getYIntercept());
        ...
        System.out.println("Solved third pair: " + "(" + x3 + "," + equation.thirdXValue(x3) + ")");
    }
}
